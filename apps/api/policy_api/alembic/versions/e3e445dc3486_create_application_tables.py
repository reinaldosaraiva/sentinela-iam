...
Revision ID: e3e445dc3486
Revises: 88cfac37e724
Create Date: 2025-11-13 11:01:29.132709
...
revision: str = 'e3e445dc3486'
down_revision: Union[str, None] = '88cfac37e724'
...
def upgrade() -> None:
    ...
    sa.CheckConstraint("environment IN ('development', 'staging', 'production')", name='check_application_environment'),
    sa.CheckConstraint("status IN ('active', 'paused', 'archived')", name='check_application_status'),
